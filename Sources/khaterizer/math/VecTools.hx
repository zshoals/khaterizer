...
class VecTools {
	...
	**/
	@:extern public inline static function makeRandomVec2(minX: Float, maxX: Float, minY: Float, maxY: Float): Vec2 {
	...
	@:extern public inline static function clampVec2(vec: Vec2, vecMin: Vec2, vecMax: Vec2): Vec2 {
